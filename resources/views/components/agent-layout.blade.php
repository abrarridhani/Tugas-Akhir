...
<body class="font-sans antialiased bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-200 transition-colors duration-300 cyber-bg min-h-screen">
    <div class="min-h-screen relative overflow-hidden" x-data="{ open: false }">
